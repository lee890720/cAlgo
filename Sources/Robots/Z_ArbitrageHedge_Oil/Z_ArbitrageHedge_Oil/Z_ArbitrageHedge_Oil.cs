...
namespace cAlgo
{
    ...
    public class Z_ArbitrageHedge_Oil : Robot
    {
        #region Parameter
        ...
        protected override void OnTick()
        {
            ...
            if (IsTrade)
            {
                ...
                if (OpenSignal() == "above")
                {
                    ...
                    {
                        initBuyS.Volume = _secondsymbol.NormalizeVolume(_initvolume, RoundingMode.ToNearest);
                ...
                if (OpenSignal() == "below")
                {
                    ...
                    if (LastResult.IsSuccessful)
                    {
                        initSellS.Volume = _secondsymbol.NormalizeVolume(_initvolume, RoundingMode.ToNearest);
