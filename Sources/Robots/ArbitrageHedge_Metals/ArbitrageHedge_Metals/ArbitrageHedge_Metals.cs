        ...
        protected override void OnTick()
        {
            ...
            if (IsTrade)
            {
                ...
                if (OpenSignal() == "above")
                {
                    ...
                    initBuyS.Volume = Init_Volume * Ratio * Math.Pow(2, Math.Floor((double)Pos_above.Count / 2));
                ...
                if (OpenSignal() == "aboveB")
                {
                    ...
                    this.executeOrder(initSellF);
                    initBuyS.Volume = Init_Volume * Ratio;
                    initBuyS.Label = AboveLabel;
                ...
                if (OpenSignal() == "below")
                {
                    ...
                    initSellS.Volume = Init_Volume * Ratio * Math.Pow(2, Math.Floor((double)Pos_below.Count / 2));
                ...
                if (OpenSignal() == "belowB")
                {
                    ...
                    this.executeOrder(initBuyF);
                    initSellS.Volume = Init_Volume * Ratio;
                    initSellS.Label = BelowLabel;
