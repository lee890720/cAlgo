    ...
    public class ToSql_Cbotset : Robot
    {
        ...
        protected override void OnTimer()
        {
            try
            {
                ...
                string strcon = "Data Source=tcp:leeinfodb.database.windows.net,1433;Initial Catalog=LeeInfoDb;User ID=lee_890720;Password=l_37355175;Integrated Security=False;Connect Timeout=15;Encrypt=False;TrustServerCertificate=False;MultipleActiveResultSets=True";
