    ...
    public class ToSql_Cbotset : Robot
    {
        ...
        protected override void OnTimer()
        {
            try
            {
                ...
                string strcon = "Server=tcp:leeinfo.database.windows.net,1433;Initial Catalog=LeeInfo;Persist Security Info=False;User ID=lee890720;Password=Lee37355175;Integrated Security=False;Connect Timeout=15;Encrypt=False;TrustServerCertificate=False;MultipleActiveResultSets=True";
