...
namespace cAlgo
{
    ...
    public class ArbitrageHedge_chf_eur_gbp : Robot
    {
        ...
        private string opensignal()
        {
            ...
            if (Pos_gbpchfabove.Count != 0)
                lastPosTime.Add(Pos_gbpchfabove[0].EntryTime.AddHours(timer));
            if (Pos_gbpchfbelow.Count != 0)
                lastPosTime.Add(Pos_gbpchfbelow[0].EntryTime.AddHours(timer));
            if (Pos_gbpeurabove.Count != 0)
                lastPosTime.Add(Pos_gbpeurabove[0].EntryTime.AddHours(timer));
            if (Pos_gbpeurbelow.Count != 0)
                lastPosTime.Add(Pos_gbpeurbelow[0].EntryTime.AddHours(timer));
        ...
        private void chartdraw()
        {
            ...
            ChartObjects.DrawText("eurchf", "\n\nSub_EURCHF\t" + Sub_eurchf.ToString() + "\tEURCHF_A\t" + Sub_eurchfabove.ToString() + "\t" + AV_eurchfabove.ToString() + "\t" + Pos_eurchfabove.Count.ToString() + "\t" + Math.Round(this.TotalProfits(eurchfAbove)) + "\tEURCHF_B\t" + Sub_eurchfbelow.ToString() + "\t" + AV_eurchfbelow.ToString() + "\t" + Pos_eurchfbelow.Count.ToString() + "\t" + Math.Round(this.TotalProfits(eurchfBelow)), StaticPosition.TopLeft, Colors.White);
            ChartObjects.DrawText("gbpchf", "\n\n\nSub_GBPCHF\t" + Sub_gbpchf.ToString() + "\tGBPCHF_A\t" + Sub_gbpchfabove.ToString() + "\t" + AV_gbpchfabove.ToString() + "\t" + Pos_gbpchfabove.Count.ToString() + "\t" + Math.Round(this.TotalProfits(gbpchfAbove)) + "\tGBPCHF_B\t" + Sub_gbpchfbelow.ToString() + "\t" + AV_gbpchfbelow.ToString() + "\t" + Pos_gbpchfbelow.Count.ToString() + "\t" + Math.Round(this.TotalProfits(gbpchfBelow)), StaticPosition.TopLeft, Colors.White);
            ChartObjects.DrawText("gbpeur", "\n\n\n\nSub_GBPEUR\t" + Sub_gbpeur.ToString() + "\tGBPEUR_A\t" + Sub_gbpeurabove.ToString() + "\t" + AV_gbpeurabove.ToString() + "\t" + Pos_gbpeurabove.Count.ToString() + "\t" + Math.Round(this.TotalProfits(gbpeurAbove)) + "\tGBPEUR_B\t" + Sub_gbpeurbelow.ToString() + "\t" + AV_gbpeurbelow.ToString() + "\t" + Pos_gbpeurbelow.Count.ToString() + "\t" + Math.Round(this.TotalProfits(gbpeurBelow)), StaticPosition.TopLeft, Colors.White);
        }
    }
}
