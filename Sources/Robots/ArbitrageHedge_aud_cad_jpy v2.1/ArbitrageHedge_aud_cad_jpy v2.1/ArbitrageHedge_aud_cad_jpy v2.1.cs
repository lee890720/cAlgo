...
namespace cAlgo
{
    ...
    public class ArbitrageHedge_aud_cad_jpy : Robot
    {
        ...
        private string opensignal()
        {
            ...
            if (Pos_cadaudabove.Count != 0)
                lastPosTime.Add(Pos_cadaudabove[0].EntryTime.AddHours(timer));
            if (Pos_cadaudbelow.Count != 0)
                lastPosTime.Add(Pos_cadaudbelow[0].EntryTime.AddHours(timer));
            if (Pos_jpyaudabove.Count != 0)
                lastPosTime.Add(Pos_jpyaudabove[0].EntryTime.AddHours(timer));
            if (Pos_jpyaudbelow.Count != 0)
                lastPosTime.Add(Pos_jpyaudbelow[0].EntryTime.AddHours(timer));
            if (Pos_jpycadabove.Count != 0)
                lastPosTime.Add(Pos_jpycadabove[0].EntryTime.AddHours(timer));
            if (Pos_jpycadbelow.Count != 0)
                lastPosTime.Add(Pos_jpycadbelow[0].EntryTime.AddHours(timer));
            ...
            double Sub_cadaudabove = distance;
            double Sub_cadaudbelow = -distance;
            double Sub_jpyaudabove = distance;
            double Sub_jpyaudbelow = -distance;
            double Sub_jpycadabove = distance;
            double Sub_jpycadbelow = -distance;
            ...
            if (Pos_cadaudabove.Count != 0)
            {
                ...
                if (Sub_cadaudabove > 0)
                    AV_cadaudabove = Math.Round(totalCom / Pos_cadaudabove.Count);
                if (Sub_cadaudabove < distance)
                    Sub_cadaudabove = distance;
            }
            if (Pos_cadaudbelow.Count != 0)
            {
                double total = 0;
                ...
                if (Sub_cadaudbelow < 0)
                    AV_cadaudbelow = Math.Round(totalCom / Pos_cadaudbelow.Count);
                if (Sub_cadaudbelow > -distance)
                    Sub_cadaudbelow = -distance;
            }
            #endregion
            ...
            if (Pos_jpyaudabove.Count != 0)
            {
                ...
                if (Sub_jpyaudabove > 0)
                    AV_jpyaudabove = Math.Round(totalCom / Pos_jpyaudabove.Count);
                if (Sub_jpyaudabove < distance)
                    Sub_jpyaudabove = distance;
            }
            if (Pos_jpyaudbelow.Count != 0)
            {
                double total = 0;
                ...
                if (Sub_jpyaudbelow < 0)
                    AV_jpyaudbelow = Math.Round(totalCom / Pos_jpyaudbelow.Count);
                if (Sub_jpyaudbelow > -distance)
                    Sub_jpyaudbelow = -distance;
            }
            #endregion
            ...
            if (Pos_jpycadabove.Count != 0)
            {
                ...
                if (Sub_jpycadabove > 0)
                    AV_jpycadabove = Math.Round(totalCom / Pos_jpycadabove.Count);
                if (Sub_jpycadabove < distance)
                    Sub_jpycadabove = distance;
            }
            if (Pos_jpycadbelow.Count != 0)
            {
                double total = 0;
                ...
                if (Sub_jpycadbelow < 0)
                    AV_jpycadbelow = Math.Round(totalCom / Pos_jpycadbelow.Count);
                if (Sub_jpycadbelow > -distance)
                    Sub_jpycadbelow = -distance;
            }
            #endregion
        ...
        private void chartdraw()
        {
            ...
            ChartObjects.DrawText("cadaud", "\n\nSub_CADAUD\t" + Sub_cadaud.ToString() + "\tCADAUD_A\t" + Sub_cadaudabove.ToString() + "\t" + AV_cadaudabove.ToString() + "\t" + Pos_cadaudabove.Count.ToString() + "\t" + Math.Round(this.TotalProfits(cadaudAbove)) + "\tCADAUD_B\t" + Sub_cadaudbelow.ToString() + "\t" + AV_cadaudbelow.ToString() + "\t" + Pos_cadaudbelow.Count.ToString() + "\t" + Math.Round(this.TotalProfits(cadaudBelow)), StaticPosition.TopLeft, Colors.White);
            ChartObjects.DrawText("jpyaud", "\n\n\nSub_JPYAUD\t" + Sub_jpyaud.ToString() + "\tJPYAUD_A\t" + Sub_jpyaudabove.ToString() + "\t" + AV_jpyaudabove.ToString() + "\t" + Pos_jpyaudabove.Count.ToString() + "\t" + Math.Round(this.TotalProfits(jpyaudAbove)) + "\tJPYAUD_B\t" + Sub_jpyaudbelow.ToString() + "\t" + AV_jpyaudbelow.ToString() + "\t" + Pos_jpyaudbelow.Count.ToString() + "\t" + Math.Round(this.TotalProfits(jpyaudBelow)), StaticPosition.TopLeft, Colors.White);
            ChartObjects.DrawText("jpycad", "\n\n\n\nSub_JPYCAD\t" + Sub_jpycad.ToString() + "\tJPYCAD_A\t" + Sub_jpycadabove.ToString() + "\t" + AV_jpycadabove.ToString() + "\t" + Pos_jpycadabove.Count.ToString() + "\t" + Math.Round(this.TotalProfits(jpycadAbove)) + "\tJPYCAD_B\t" + Sub_jpycadbelow.ToString() + "\t" + AV_jpycadbelow.ToString() + "\t" + Pos_jpycadbelow.Count.ToString() + "\t" + Math.Round(this.TotalProfits(jpycadBelow)), StaticPosition.TopLeft, Colors.White);
        }
    }
}
