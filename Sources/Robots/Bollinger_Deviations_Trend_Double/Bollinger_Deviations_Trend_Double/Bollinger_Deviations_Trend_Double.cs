...
namespace cAlgo
{
    ...
    public class Bollinger_Deviations_Trend_Double : Robot
    {
        #region Parameter
        ...
        #endregion
        #region Orders
        private int TotalOrders(Position[] pos)
        {
            int totalOrders;
            totalOrders = 0;
            if (pos.Length != 0)
