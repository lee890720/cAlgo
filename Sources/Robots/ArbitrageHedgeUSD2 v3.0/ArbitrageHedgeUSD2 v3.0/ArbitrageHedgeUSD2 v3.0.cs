...
namespace cAlgo
{
    ...
    public class ArbitrageHedgeUSD : Robot
    {
        ...
        private void chartdraw()
        {
            ...
            ChartObjects.DrawText("cadaud", "\nSub_CADAUD\t" + Sub_cadaud.ToString() + "\tCADAUD_A\t" + Sub_cadaudabove.ToString() + "\t" + AV_cadaudabove.ToString() + "\t" + Pos_cadaudabove.Count.ToString() + "\t" + this.TotalProfits(cadaudAbove) + "\tCADAUD_B\t" + Sub_cadaudbelow.ToString() + "\t" + AV_cadaudbelow.ToString() + "\t" + Pos_cadaudbelow.Count.ToString() + "\t" + this.TotalProfits(cadaudBelow), StaticPosition.TopLeft, Colors.White);
            ChartObjects.DrawText("jpyaud", "\n\nSub_JPYAUD\t" + Sub_jpyaud.ToString() + "\tJPYAUD_A\t" + Sub_jpyaudabove.ToString() + "\t" + AV_jpyaudabove.ToString() + "\t" + Pos_jpyaudabove.Count.ToString() + "\t" + this.TotalProfits(jpyaudAbove) + "\tJPYAUD_B\t" + Sub_jpyaudbelow.ToString() + "\t" + AV_jpyaudbelow.ToString() + "\t" + Pos_jpyaudbelow.Count.ToString() + "\t" + this.TotalProfits(jpyaudBelow), StaticPosition.TopLeft, Colors.White);
            ChartObjects.DrawText("jpycad", "\n\n\nSub_JPYCAD\t" + Sub_jpycad.ToString() + "\tJPYCAD_A\t" + Sub_jpycadabove.ToString() + "\t" + AV_jpycadabove.ToString() + "\t" + Pos_jpycadabove.Count.ToString() + "\t" + this.TotalProfits(jpycadAbove) + "\tJPYCAD_B\t" + Sub_jpycadbelow.ToString() + "\t" + AV_jpycadbelow.ToString() + "\t" + Pos_jpycadbelow.Count.ToString() + "\t" + this.TotalProfits(jpycadBelow), StaticPosition.TopLeft, Colors.White);
            #endregion
        }
    }
}
