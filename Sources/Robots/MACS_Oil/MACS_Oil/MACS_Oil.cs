    ...
    public class MACS_Oil : Robot
    {
        ...
        protected override void OnTick()
        {
            ...
            if (Poss_xbr.Count >= 2 && Poss_xti.Count >= 2)
            {
                ...
                {
                    if (_marklist.Contains(Pos_xbr_Last.Comment.Substring(15, 13)))
                        if (_marklist.Remove(Pos_xbr_Last.Comment.Substring(15, 13)))
            ...
            if (_istrade)
            {
                ...
                if (GetOpen() == "above")
                {
                    ...
                    _initsell.Comment += string.Format("{0:000}", Poss_xbr.Count + 1) + "<";
                ...
                if (GetOpen() == "below")
                {
                    ...
                    _initbuy.Comment += string.Format("{0:000}", Poss_xbr.Count + 1) + "<";
