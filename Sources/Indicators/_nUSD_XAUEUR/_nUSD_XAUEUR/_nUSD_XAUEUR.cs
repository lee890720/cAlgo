...
namespace cAlgo
{
    ...
    public class _nUSD_XAUEUR : Indicator
    {
        [Output("Result")]
        ...
        public override void Calculate(int index)
        {
            ...
            Result[index] = (_symbolbigSeries.Close[BigIndex] / 2000 - _symbolsmallSeries.Close[SmallIndex]) / 0.0001 + 10000;
            double sum = 0.0;
            ...
            if (opensignal() == "Above_XAUEUR")
                ResultAbove[index] = Result[index];
            if (opensignal() == "Below_XAUEUR")
