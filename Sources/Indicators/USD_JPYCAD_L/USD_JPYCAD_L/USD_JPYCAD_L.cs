...
namespace cAlgo
{
    ...
    public class USD_JPYCAD_L : Indicator
    {
        [Output("Result")]
        ...
        private string BigSymbol = "USDJPY";
        private string SmallSymbol = "USDCAD";
        ...
        public override void Calculate(int index)
        {
            ...
            Result[index] = (100 / _symbolbigSeries.Close[BigIndex] - 1 / _symbolsmallSeries.Close[SmallIndex]) / 0.0001 + 10000;
            double sum = 0.0;
