...
namespace cAlgo
{
    ...
    public class JPY_GBPCHF : Indicator
    {
        [Output("Result")]
        ...
        private string BigSymbol = "GBPJPY";
        private string SmallSymbol = "CHFJPY";
        ...
        public override void Calculate(int index)
        {
            ...
            Result[index] = (_symbolbigSeries.Close[BigIndex] - _symbolsmallSeries.Close[SmallIndex]) / 0.01 + 10000;
            double sum = 0.0;
