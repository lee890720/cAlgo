...
namespace cAlgo
{
    ...
    public class Magnify_MAS : Indicator
    {
        [Output("Result")]
        ...
        public int _BarsAgo;
        public string _Mark;
        private Magnify_MaCross _mac;
        private Magnify_MaSub _mas;
        private Colors _nocorel;

        protected override void Initialize()
        {
            _mac = Indicators.GetIndicator<Magnify_MaCross>(ResultPeriods, AveragePeriods, Magnify);
            _mas = Indicators.GetIndicator<Magnify_MaSub>(ResultPeriods, AveragePeriods, Magnify);
